...
public class RecordDemo extends Application {
    ...
    record Person (String firstName,String lastName, LocalDate birthdate){
        ...
        public int getAge(){
          ...
          //  int birthMonth = Integer.parseInt(birthdate.getMonth());
           ...
           // if (today.getMonth()>birthdate.getMonth())
            ...
            else age = today.getYear()-birthdate.getYear()-1;


            }

            //greatest possible age
            // calculate persons exact age
    ...
    private void setup() throws Exception {
        ...
        String[] lines = getLinesFromFile("nameList.csv");
